...
from fn_data_analysis import postprocess_generate_report_1
...
class AdminDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.dir_line = QLineEdit(self)
        self.dir_line.setPlaceholderText("Enter new file path")
    ...
    def showEvent(self, event):
        self.dir_line.setText(self.parent().file1)
...
class RunScanWidget_1(QWidget):
    ...
    def loadSettings(self):
        try:
            ...
            # existing settings
            self.file1 = settings.get('file', self.file1)
    ...
    def initUI(self):
        ...
        self.run_button = QPushButton('Start Run', self)
        self.pp_button = QPushButton('Post-Process', self)

        self.run_button.clicked.connect(lambda: self.startTimer(self.run_button))
